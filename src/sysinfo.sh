...
check_yq() {
    if ! command -v yq >/dev/null 2>&1; then
        ...
        echo ""
        echo "Install yq:"
        echo "Install yq (auto-detects CPU arch: amd64/arm64/arm):"
        echo "  curl -sSL https://github.com/mikefarah/yq/releases/latest/download/\$(case \$(uname -m) in x86_64|amd64) echo yq_linux_amd64;; aarch64|arm64) echo yq_linux_arm64;; *) echo yq_linux_arm;; esac) -o /usr/local/bin/yq"
